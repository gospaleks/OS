...
/*
    ...
    verzija 1 - citanje sa standardnog ulaza dok se ne unese KRAJ
    verzija 2 (ovaj kod) - citanje iz fajla dok se ne naidje na liniju KRAJ
*/
...
int main()
{
    ...
    if (pid != 0)
    {
        ...
        do
        {
            ...
            fgets(linija, MEM_VELICINA, f);
            printf("proces RODITELJ - citanje linije: %s", linija);
